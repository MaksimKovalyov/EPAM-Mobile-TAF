...
//import com.parallels.proxy.integration.utils.tcp.StringExplicitTypeFactory;
...
import com.epam.mobile.driver.core.TAFException;
...
public class StubHost {
	...
	private final static Logger logger = TAFLoggerFactory.getLogger(StubHost.class);
...
//	private static final int AUTH_SITE_TIMEOUT = 10000;
	...
	public boolean sendCommand(String url, 
								String commandName, 
								String commandData) throws TAFException{
