...
class DeviceCommands{
	...
	// add finally: clear resources
	public boolean simulateMemoryWarning() throws TAFException{
	...
	public boolean pingServer() throws TAFException{
		boolean result = host.sendCommand(
				Configurator.getInstance().getServerURL(),
...
class UICommands{
	...
	public boolean setElementValue() throws TAFException{
	...
	public boolean getElementValue() throws TAFException{
	...
	public boolean getElement() throws TAFException{
	...
	public boolean doAction() throws TAFException{
...
public class DriverCommands{
	...
	public static class SetElementValue implements Command{
		public boolean execute() throws TAFException {
