...
import com.epam.mobile.exampleproject.tests.architecture.design.screens.specification.AppView;
...
// clarify: static final vs unstatic logger.  
...
//		garbage.add(actualLoginHASH);
	...
	public String[] getSomethingBySOAP(String device, String token,
		...
		//logger.info("              ... expected something data: {}", actualsomethingData);
		logger.info("              ... expected something data: " + actualSomethingData);
		// garbage.add(actualLoginHASH);
