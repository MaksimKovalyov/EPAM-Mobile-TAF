...
public class CustomAssertUnitTests {
	...
	protected static String unexpected;
	...
	@Test(expected=AssertionError.class)
	public void isAssertNotSameSameStringsValid(){
		unexpected = "Global Markets";
		actual = "Global Markets";
	...
	@Test
	public void isAssertNotSameNotSameStringsValid(){
		String unexpected = "The string.";
		String actual = "The other string.";
